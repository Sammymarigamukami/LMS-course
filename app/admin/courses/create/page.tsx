// i will later update the price and duration to number when react-hook-form supports z.coerce.number()
"use client"
            ...
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        /> 
                        <Button className="w-fit" type="button" onClick={generateSlug}>
