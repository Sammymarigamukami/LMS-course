...
const features: featureProps[] = [
  ...
  }, 
  {
    ...
    description: "Engage with interactive content, quizzes, and assignments to reinforce your understanding",
    icon: "🧑‍💻",
  },
  {
    ...
    <section className="relative py-20">
      <div className="flex flex-col items-center text-center space-y-8">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight max-w-4xl">
          Elevate your learning journey with our cutting-edge LMS platform
        </h1>
        <p className = "max-w-[700px] md:text-xl text-muted-foreground">
          ...
          system. Access high-quality cources anytime, anywhere.
        </p>
